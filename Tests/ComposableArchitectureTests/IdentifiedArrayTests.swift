...
final class IdentifiedArrayTests: XCTestCase {
  func testIdSubscript() {
    ...
    let array: IdentifiedArray<User.ID, User> = .init([User(id: 1, name: "Blob")])
  ...
  func testRemoveId() {
    ...
    var array: IdentifiedArray<User.ID, User> = .init([User(id: 1, name: "Blob")])

    XCTAssertEqual(array.remove(id: 1), User(id: 1, name: "Blob"))
    XCTAssertEqual(array, IdentifiedArray<User.ID, User>([]))
  }
  ...
  func testInsert() {
    ...
    XCTAssertEqual(array, IdentifiedArray<User.ID, User>([User(id: 2, name: "Blob Jr."), User(id: 1, name: "Blob")]))
  }
  ...
  func testInsertContentsOf() {
    ...
    XCTAssertEqual(
      array,
        IdentifiedArray<User.ID, User>([User(id: 3, name: "Blob Sr."), User(id: 2, name: "Blob Jr."), User(id: 1, name: "Blob")])
    )
  }
  ...
  func testRemoveAt() {
    ...
    var array: IdentifiedArray<User.ID, User> = .init([
    ...
    array.remove(at: 1)
    XCTAssertEqual(array, IdentifiedArray<User.ID, User>([User(id: 3, name: "Blob Sr."), User(id: 1, name: "Blob")]))
  }
  ...
  func testRemoveAllWhere() {
    ...
    XCTAssertEqual(array, IdentifiedArray<User.ID, User>([User(id: 1, name: "Blob")]))
  }
  ...
  func testRemoveAtOffsets() {
    ...
    XCTAssertEqual(array, IdentifiedArray<User.ID, User>([User(id: 2, name: "Blob Jr.")]))
  }
  ...
  func testMoveFromOffsets() {
    ...
    XCTAssertEqual(
      array,
        IdentifiedArray<User.ID, User>([User(id: 2, name: "Blob Jr."), User(id: 3, name: "Blob Sr."), User(id: 1, name: "Blob")])
    )
  }
...
//    )
  ...
  func testSortBy() {
    ...
    var array: IdentifiedArray<ComparableValue.ID, ComparableValue> = .init([
      ComparableValue(id: 1, value: 100),
      ComparableValue(id: 2, value: 50),
      ComparableValue(id: 3, value: 75),
    ])

    let expected: IdentifiedArray<ComparableValue.ID, ComparableValue> = .init([
        ComparableValue(id: 2, value: 50),
      ComparableValue(id: 3, value: 75),
        ComparableValue(id: 1, value: 100),
    ])
  ...
  func testSort() {
    ...
    XCTAssertEqual([2, 3, 1], array.ids)
    XCTAssertEqual(
        IdentifiedArray<ComparableValue.ID, ComparableValue>([
        ComparableValue(id: 2, value: 50),
        ComparableValue(id: 3, value: 75),
        ComparableValue(id: 1, value: 100),
      ]), array)
